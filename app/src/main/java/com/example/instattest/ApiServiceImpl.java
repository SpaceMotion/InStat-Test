...
public class ApiServiceImpl {
    public static void getMatch(long id, Callback<ResponseBody> callback) throws JSONException {
    ...
    public static void getVideos(long matchId, Callback<ResponseBody> callback) throws JSONException {
        ApiService apiService = getApiService();
